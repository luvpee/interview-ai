...
const Interview = () => {
    ...
    if (loading || !report) {
        return <LoadingScreen isInitialFetch={true} />
    }
                ...
                <nav className='interview-nav'>
                    ...
                    <div className='download-resume-wrapper'>
                        <button
                            ...
                            className={`button primary-button download-resume-btn ${downloadingResume ? 'download-resume-btn--loading' : ''} ${downloadSuccess ? 'download-resume-btn--success' : ''}`}
                            title='Download AI-generated tailored resume as PDF'
                        >
                            {downloadingResume ? (
                                ...
                                <span className='download-btn-content'>
                                    <svg height="14" width="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                                    Downloaded!
                                </span>
                            ) : (
                                <span className='download-btn-content'>
                        ...
                        {downloadError && (
                            <p className='download-error-text'>{downloadError}</p>
                        )}
                    </div>
                </nav>
